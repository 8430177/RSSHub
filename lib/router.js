...
// bestofshowhn
router.get('/bestofshowhn/:query', require('./routes/bestofshowhn/index'));

// unix论坛
router.get('/chinaunix', require('./routes/chinaunix/index'));

// mottoin
router.get('/mottoin', require('./routes/mottoin/index'));

// 赏金论坛
router.get('/sgoldcn', require('./routes/sgoldcn/index'));

// hackforums（被Bloak）
router.get('/hackforums', require('./routes/hackforums/index')); // 还未订阅

// warriorforum
router.get('/warriorforum/:query', require('./routes/warriorforum/index'));

// wickedfire
router.get('/wickedfire', require('./routes/wickedfire/index')); // 还未订阅

// amz520
router.get('/amz520', require('./routes/amz520/index'));

// ms509
router.get('/ms509', require('./routes/ms509/index'));

// t00ls
router.get('/t00ls/:query', require('./routes/t00ls/index'));

// jb51（乱码代解决）
router.get('/jb51/:query', require('./routes/jb51/index'));

// 91xixiang
router.get('/91xixiang', require('./routes/91xixiang/index'));

// alexzk
router.get('/alexzk', require('./routes/alexzk/index'));

// amz123
router.get('/amz123', require('./routes/amz123/index'));

// ikjzd
router.get('/ikjzd', require('./routes/ikjzd/index'));

// sec-wik (start)
router.get('/sec-wiki/:query', require('./routes/sec-wiki/index'));

// skladchik(众筹论坛)
router.get('/skladchik', require('./routes/skladchik/index'));
// 52by(邦阅网)
router.get('/52by', require('./routes/52by/index'));
// mjzj（卖家之家）
router.get('/mjzj', require('./routes/mjzj/index'));

// 通用feed语言翻译
router.get('/fanyi/:query', require('./routes/fanyi/index'));

router.get('/fanyi_pro/:query', require('./routes/fanyi_pro/index'));

router.get('/richadvert/:query', require('./routes/richadvert/index'));

// （代解决）
// router.get('/lolz', require('./routes/lolz/index'));

router.get('/affdaily', require('./routes/affdaily/index'));

router.get('/affpaying', require('./routes/affpaying/index'));

router.get('/facebook6688', require('./routes/facebook6688/index'));

router.get('/shcherbakovs', require('./routes/shcherbakovs/index'));

router.get('/sinoclick', require('./routes/sinoclick/index'));


// (代解决)
router.get('/coockie', require('./routes/coockie/index'));

router.get('/vk/:query', require('./routes/vk/index'));

router.get('/affbuzz', require('./routes/affbuzz/index'));

router.get('/conversion', require('./routes/conversion/index'));

// gupowang
router.get('/gupowang', require('./routes/gupowang/index'));

// darkmoney
router.get('/darkmoney', require('./routes/darkmoney/index'));
